...
function openSettings() {
  ...
  document.getElementById("auto-complete").checked =
  ...
  document.getElementById("progressive-difficulty").checked =
    settings.learning.progressiveDifficulty;
  document.getElementById("solution-timer").checked =
    settings.learning.solutionTimer;
  document.getElementById("achievement-popups").checked =
    settings.notifications.achievementPopups;
  document.getElementById("daily-reminders").checked =
    settings.notifications.dailyReminders;
  document.getElementById("streak-warnings").checked =
    settings.notifications.streakWarnings;
}
...
function toggleProgressiveDifficulty(enabled) {
  ...
  showToast(
    `Progressive difficulty ${enabled ? "enabled" : "disabled"}`,
    "info"
  );
}
