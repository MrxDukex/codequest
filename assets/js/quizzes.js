...
function getQuizzes() {
  return {
    ...
    "html-quiz-3": {
      ...
      category: "HTML",
      description: "Test your knowledge of advanced HTML elements and structure",
      requiredChallenges: ["html-11", "html-12", "html-13", "html-14", "html-15"],
      passingScore: 70,
      xpReward: 75,
      questions: [
        {
          id: "hq3-1",
          type: "multiple-choice",
          question: "Which HTML5 element represents a self-contained composition?",
          options: ["<div>", "<article>", "<section>", "<container>"],
          correctAnswer: 1,
          explanation: "<article> represents a self-contained composition like a blog post or news story."
        },
        {
          id: "hq3-2",
          type: "code",
          ...
          correctAnswer: '<nav>\n  <a href="#">Home</a>\n  <a href="#">About</a>\n  <a href="#">Contact</a>\n</nav>',
          testFunction: (code) => {
            return code.includes("<nav>") && code.includes("</nav>") && 
                   code.includes("<a") && (code.match(/<a/g) || []).length >= 3;
          },
          explanation: "Use <nav> for navigation menus with anchor tags <a> for links."
        },
        {
          id: "hq3-3",
          type: "multiple-choice",
          ...
          correctAnswer: 1,
          explanation: "<main> contains the dominant content of the <body>, excluding headers, footers, and sidebars."
        },
        {
          id: "hq3-4",
          type: "code",
          ...
          testFunction: (code) => {
            return code.includes("<figure>") && code.includes("<img") && code.includes("<figcaption>");
          },
          explanation: "<figure> groups media with <figcaption> for accessible image descriptions."
        },
        {
          id: "hq3-5",
          type: "multiple-choice",
          ...
          correctAnswer: 1,
          explanation: "The 'readonly' attribute prevents users from editing the field while still submitting its value."
        }
      ],
    ...
    "html-quiz-4": {
      ...
      requiredChallenges: ["html-16", "html-17", "html-18", "html-19", "html-20"],
      passingScore: 70,
      xpReward: 75,
      questions: [
        {
          ...
          correctAnswer: 1,
          explanation: "<section> represents a thematic grouping with semantic meaning, while <div> is a generic container."
        },
        {
          id: "hq4-2",
          type: "code",
          ...
          starterCode: "<!-- Write your code here -->\n",
          correctAnswer: '<div class="video-container">\n  <iframe src="video-url" title="Video" allowfullscreen></iframe>\n</div>',
          testFunction: (code) => {
            return code.includes("<iframe") && code.includes("src=") && code.includes("</iframe>");
          },
          explanation: "Use <iframe> for embedded content with src attribute and proper title for accessibility."
        },
        {
          id: "hq4-3",
          type: "multiple-choice",
          ...
          correctAnswer: 1,
          explanation: "The viewport meta tag ensures proper rendering on mobile devices by setting the width to device width."
        },
        {
          id: "hq4-4",
          type: "code",
          ...
          testFunction: (code) => {
            return code.includes("<table>") && code.includes("<th>") && 
                   code.includes("<thead>") && code.includes("<tbody>");
          },
          explanation: "Semantic tables use <thead>, <tbody>, and <th> elements for proper structure and accessibility."
        },
        {
          id: "hq4-5",
          type: "multiple-choice",
          ...
          correctAnswer: 1,
          explanation: "'defer' downloads the script in parallel but executes it only after HTML parsing is complete."
        }
      ],
    ...
    "html-final-exam": {
      ...
      category: "HTML",
      description: "Comprehensive exam covering all HTML concepts from this path",
      requiredChallenges: ["html-01", "html-02", "html-03", "html-04", "html-05",
                          "html-06", "html-07", "html-08", "html-09", "html-10",
                          "html-11", "html-12", "html-13", "html-14", "html-15",
                          "html-16", "html-17", "html-18", "html-19", "html-20"],
      requiredQuizzes: ["html-quiz-1", "html-quiz-2", "html-quiz-3", "html-quiz-4"],
      passingScore: 75,
      xpReward: 150,
      questions: [
        {
          ...
          correctAnswer: 1,
          explanation: "<h1> represents the most important heading, down to <h6> which is the least important."
        },
        {
          id: "hfe-2",
          type: "code",
          question: "Create a complete contact form with name, email, message, and submit button",
          starterCode: "<!-- Write your HTML here -->\n",
          correctAnswer: '<form>\n  <label for="name">Name</label>\n  <input type="text" id="name" required>\n  \n  <label for="email">Email</label>\n  <input type="email" id="email" required>\n  \n  <label for="message">Message</label>\n  <textarea id="message" required></textarea>\n  \n  <button type="submit">Send</button>\n</form>',
          testFunction: (code) => {
            return code.includes("<form>") && code.includes('type="text"') && 
                   code.includes('type="email"') && code.includes("<textarea") &&
                   code.includes("<button") && code.includes("<label");
          },
          explanation: "A proper form includes labels connected to inputs, appropriate input types, and a submit button."
        },
        {
          id: "hfe-3",
          type: "multiple-choice",
          ...
          correctAnswer: 1,
          explanation: "Block-level elements like <div>, <p>, and <section> take up the full width available."
        },
        {
          id: "hfe-4",
          type: "code",
          question: "Create a semantic article structure with header, main content, and footer",
          starterCode: "<!-- Write your HTML here -->\n",
          correctAnswer: '<article>\n  <header>\n    <h2>Article Title</h2>\n  </header>\n  <p>Main content here</p>\n  <footer>Published: 2024</footer>\n</article>',
          testFunction: (code) => {
            return code.includes("<article>") && code.includes("<header>") && 
                   code.includes("<footer>") && code.includes("</article>");
          },
          explanation: "Semantic structure uses <article>, <header>, and <footer> for meaningful content organization."
        },
        {
          id: "hfe-5",
          type: "multiple-choice",
        ...
        },
        {
          ...
          testFunction: (code) => {
            return code.includes("<nav>") && (code.match(/<a/g) || []).length >= 4;
          },
          explanation: "Navigation menus should use <nav> with anchor tags linking to different sections or pages."
        },
        {
          id: "hfe-7",
          type: "multiple-choice",
          question: "Which HTML5 input type validates email format automatically?",
          options: [
            'type="text"',
            'type="email"',
            'type="mail"',
          ...
          correctAnswer: 1,
          explanation: 'type="email" provides built-in validation for email format in modern browsers.'
        },
        {
          id: "hfe-8",
          type: "code",
          ...
          testFunction: (code) => {
            return code.includes("<dl>") && code.includes("<dt>") && code.includes("<dd>");
          },
          explanation: "Definition lists use <dl> with <dt> for terms and <dd> for descriptions."
        }
      ],
      remedialChallenges: ["html-01", "html-05", "html-10", "html-15", "html-20"]
    },
    ...
    "css-quiz-3": {
      ...
      category: "CSS",
      description: "Test your knowledge of advanced CSS properties and techniques",
      ...
      questions: [
        {
          ...
          correctAnswer: 1,
          explanation: "position: relative positions an element relative to where it would normally be, allowing offset adjustments."
        },
        {
          id: "cq3-2",
          type: "code",
          question: "Create a CSS animation that fades in an element over 1 second",
          starterCode: "/* Write your CSS here */\n",
          correctAnswer: '@keyframes fadeIn {\n  from { opacity: 0; }\n  to { opacity: 1; }\n}\n.fade {\n  animation: fadeIn 1s;\n}',
          testFunction: (code) => {
            return code.includes("@keyframes") && code.includes("opacity") && code.includes("animation:");
          },
          explanation: "CSS animations use @keyframes to define the animation stages and animation property to apply it."
        },
        {
          id: "cq3-3",
          type: "multiple-choice",
          ...
          correctAnswer: 1,
          explanation: "border-radius creates rounded corners on elements. Values can be in px, %, or other units."
        },
        {
          id: "cq3-4",
          type: "code",
          ...
          explanation: "box-shadow adds depth with syntax: horizontal vertical blur spread color."
        },
        {
          id: "cq3-5",
          type: "multiple-choice",
          ...
          correctAnswer: 1,
          explanation: "visibility: hidden hides the element but keeps its space. display: none removes it from the layout entirely."
        }
      ],
    ...
    "css-quiz-4": {
      ...
      category: "CSS",
      description: "Advanced CSS concepts including transforms and modern layouts",
      ...
      questions: [
        {
          ...
          correctAnswer: 1,
          explanation: "transform: scale(2) makes an element twice its original size in both width and height."
        },
        {
          id: "cq4-2",
          type: "code",
          ...
          testFunction: (code) => {
            return code.includes("display: grid") && code.includes("grid-template-columns") && 
                   code.includes("gap") && code.includes("1fr");
          },
          explanation: "CSS Grid uses grid-template-columns with fr units for flexible columns and gap for spacing."
        },
        {
          id: "cq4-3",
          type: "multiple-choice",
          ...
          correctAnswer: 1,
          explanation: "z-index controls the vertical stacking order of positioned elements (relative, absolute, fixed)."
        },
        {
          id: "cq4-4",
          type: "code",
          question: "Create a media query that applies styles for screens under 768px",
          starterCode: "/* Write your CSS here */\n",
          correctAnswer: '@media (max-width: 768px) {\n  .container {\n    width: 100%;\n  }\n}',
          testFunction: (code) => {
            return code.includes("@media") && code.includes("max-width") && code.includes("768");
          },
          explanation: "Media queries use @media with conditions like max-width to apply styles based on screen size."
        },
        {
          id: "cq4-5",
          type: "multiple-choice",
          ...
          correctAnswer: 1,
          explanation: "text-transform: uppercase converts all text to uppercase letters. Other values include lowercase and capitalize."
        }
      ],
    ...
    "css-final-exam": {
      ...
      category: "CSS",
      description: "Comprehensive exam covering all CSS concepts from this path",
      requiredChallenges: ["css-01", "css-02", "css-03", "css-04", "css-05",
                          "css-06", "css-07", "css-08", "css-09", "css-10",
                          "css-11", "css-12", "css-13", "css-14", "css-15",
                          "css-16", "css-17", "css-18", "css-19", "css-20"],
      ...
      questions: [
        {
          ...
          correctAnswer: 1,
          explanation: "CSS uses: selector { property: value; } with semicolons to separate declarations."
        },
        {
          id: "cfe-2",
          type: "code",
          question: "Create a centered button with padding, rounded corners, and hover effect",
          starterCode: "/* Write your CSS here */\n",
          correctAnswer: '.button {\n  display: block;\n  margin: 0 auto;\n  padding: 12px 24px;\n  border-radius: 8px;\n  background: #007bff;\n  color: white;\n}\n.button:hover {\n  background: #0056b3;\n}',
          testFunction: (code) => {
            return code.includes("padding") && code.includes("border-radius") && 
                   code.includes(":hover") && code.includes("margin");
          },
          explanation: "Combine display: block, margin: auto for centering, padding for space, and :hover for interactivity."
        },
        {
          id: "cfe-3",
          type: "multiple-choice",
          ...
          correctAnswer: 1,
          explanation: "CSS specificity hierarchy: Element selectors < Class selectors < ID selectors < Inline styles."
        },
        {
          id: "cfe-4",
          type: "code",
          question: "Create a flexbox layout with items centered vertically and spaced evenly",
          starterCode: "/* Write your CSS here */\n",
          correctAnswer: '.container {\n  display: flex;\n  align-items: center;\n  justify-content: space-evenly;\n}',
          testFunction: (code) => {
            return code.includes("display: flex") && code.includes("align-items") && 
                   code.includes("justify-content");
          },
          explanation: "Flexbox uses align-items for vertical alignment and justify-content for horizontal distribution."
        },
        {
          id: "cfe-5",
          type: "multiple-choice",
          ...
          correctAnswer: 1,
          explanation: "rem (root em) is relative to the root element's font size, making it consistent across the page."
        },
        {
          id: "cfe-6",
          type: "code",
          question: "Create a CSS transition that animates all properties over 0.3 seconds",
          starterCode: "/* Write your CSS here */\n",
          correctAnswer: '.element {\n  transition: all 0.3s ease;\n}',
          testFunction: (code) => {
            return code.includes("transition") && code.includes("0.3");
          },
          explanation: "CSS transitions use: transition: property duration timing-function; 'all' animates all changing properties."
        },
        {
          id: "cfe-7",
          type: "multiple-choice",
          ...
          correctAnswer: 1,
          explanation: ":first-child selects an element that is the first child of its parent."
        },
        {
          id: "cfe-8",
          type: "code",
          ...
          correctAnswer: 'img {\n  max-width: 100%;\n  height: auto;\n}',
          testFunction: (code) => {
            return code.includes("max-width: 100%") && code.includes("height: auto");
          },
          explanation: "max-width: 100% prevents overflow, and height: auto maintains aspect ratio."
        }
      ],
    ...
    "js-quiz-2": {
      ...
      category: "JavaScript",
      description: "Test your understanding of DOM manipulation and event handling",
      ...
      questions: [
        ...
        },
        {
          id: "jq2-2",
          type: "code",
          question: "Select an element with id 'title' and change its text to 'Hello'",
          starterCode: "// Write your JavaScript here\n",
          correctAnswer: "document.getElementById('title').textContent = 'Hello';",
          testFunction: (code) => {
            return code.includes("getElementById") && code.includes("textContent") && code.includes("Hello");
          },
          explanation: "Use getElementById() to select by ID and textContent to change the text."
        },
        {
          id: "jq2-3",
          type: "multiple-choice",
          ...
          correctAnswer: 1,
          explanation: "textContent treats everything as plain text, while innerHTML parses HTML tags (potential security risk)."
        },
        {
          id: "jq2-4",
          type: "code",
          question: "Add a click event listener to a button that logs 'Clicked!'",
          starterCode: "const btn = document.querySelector('button');\n// Add your code here\n",
          correctAnswer: "const btn = document.querySelector('button');\nbtn.addEventListener('click', () => {\n  console.log('Clicked!');\n});",
          testFunction: (code) => {
            return code.includes("addEventListener") && code.includes("'click'") && code.includes("console.log");
          },
          explanation: "addEventListener takes the event type ('click') and a callback function to execute."
        },
        {
          id: "jq2-5",
          type: "multiple-choice",
          ...
          correctAnswer: 1,
          explanation: "querySelectorAll() returns all elements matching a CSS selector as a NodeList."
        }
      ],
    ...
    "js-quiz-3": {
      ...
      category: "JavaScript",
      description: "Test your knowledge of arrays, objects, and data manipulation",
      ...
      questions: [
        ...
        },
        {
          ...
          testFunction: (code) => {
            return code.includes("{") && code.includes("name") && code.includes("age");
          },
          explanation: "Objects use curly braces with key-value pairs separated by commas."
        },
        {
          id: "jq3-3",
          type: "multiple-choice",
          ...
          correctAnswer: 1,
          explanation: ".map() returns a NEW array with each element transformed by the callback function."
        },
        {
          id: "jq3-4",
          type: "code",
          question: "Filter an array to keep only numbers greater than 10",
          starterCode: "const numbers = [5, 15, 8, 20, 3];\n// Write your code here\n",
          correctAnswer: "const numbers = [5, 15, 8, 20, 3];\nconst filtered = numbers.filter(n => n > 10);",
          testFunction: (code) => {
            return code.includes(".filter") && code.includes(">") && code.includes("10");
          },
        ...
        },
        {
          ...
          correctAnswer: 1,
          explanation: "Use dot notation (obj.prop) or bracket notation (obj['prop']) to access object properties."
        }
      ],
      ...
      questions: [
        {
          ...
          correctAnswer: 1,
          explanation: "A closure is when a function retains access to variables from its outer (enclosing) function scope."
        },
        {
          id: "jq4-2",
          type: "code",
          ...
          explanation: "The spread operator (...) expands arrays, allowing easy concatenation: [...arr1, ...arr2]."
        },
        {
          id: "jq4-3",
          type: "multiple-choice",
        ...
        },
        {
          ...
          correctAnswer: "const user = { name: 'Alice', age: 30 };\nconst { name } = user;",
          testFunction: (code) => {
            return code.includes("{ name }") && code.includes("user");
          },
          explanation: "Destructuring uses curly braces to extract properties: const { name } = object;"
        },
        {
          id: "jq4-5",
          type: "multiple-choice",
          ...
          correctAnswer: 1,
          explanation: "'===' checks both value AND type (strict equality), while '==' only checks value (type coercion)."
        }
      ],
      ...
      questions: [
        {
          ...
          correctAnswer: 1,
          explanation: "try...catch handles errors without crashing the program, allowing graceful error recovery."
        },
        {
          id: "jq5-2",
          type: "code",
          ...
          starterCode: "// Write your JavaScript here\n",
          correctAnswer: "const promise = new Promise((resolve) => {\n  setTimeout(() => resolve('Success'), 1000);\n});",
          testFunction: (code) => {
            return code.includes("new Promise") && code.includes("resolve") && code.includes("setTimeout");
          },
          explanation: "Promises represent async operations. Use setTimeout with resolve to create a delayed promise."
        },
        {
          id: "jq5-3",
          type: "multiple-choice",
          ...
          correctAnswer: 1,
          explanation: ".reduce() executes a reducer function on each element, returning a single output value."
        },
        {
          id: "jq5-4",
          type: "code",
          question: "Use template literals to create a greeting with a name variable",
          starterCode: "const name = 'World';\n// Write your code here\n",
          correctAnswer: "const name = 'World';\nconst greeting = `Hello, ${name}!`;",
          testFunction: (code) => {
            return code.includes("`") && code.includes("${") && code.includes("name");
          },
          explanation: "Template literals use backticks and ${} for variable interpolation: `Hello, ${name}!`"
        },
        {
          id: "jq5-5",
          type: "multiple-choice",
          ...
          correctAnswer: 1,
          explanation: "localStorage stores data persistently in the browser with no expiration, surviving page reloads."
        }
      ],
    ...
    "js-final-exam": {
      ...
      category: "JavaScript",
      description: "Comprehensive exam covering all JavaScript concepts from this path",
      requiredChallenges: ["js-01", "js-02", "js-03", "js-04", "js-05",
                          "js-06", "js-07", "js-08", "js-09", "js-10",
                          "js-11", "js-12", "js-13", "js-14", "js-15",
                          "js-16", "js-17", "js-18", "js-19", "js-20",
                          "js-21", "js-22", "js-23", "js-24", "js-25"],
      requiredQuizzes: ["js-quiz-1", "js-quiz-2", "js-quiz-3", "js-quiz-4", "js-quiz-5"],
      passingScore: 75,
      xpReward: 150,
      questions: [
        {
          ...
          correctAnswer: 2,
          explanation: "'const' declares a constant that cannot be reassigned (though objects/arrays can be mutated)."
        },
        {
          id: "jfe-2",
          type: "code",
          question: "Create a function that takes an array and returns the sum of all numbers",
          starterCode: "// Write your JavaScript here\n",
          correctAnswer: "function sum(arr) {\n  return arr.reduce((acc, num) => acc + num, 0);\n}",
          testFunction: (code) => {
            return code.includes("function") && (code.includes("reduce") || code.includes("for")) && code.includes("return");
          },
          explanation: "Use reduce() to accumulate values: arr.reduce((acc, num) => acc + num, 0);"
        },
        {
          id: "jfe-3",
          type: "multiple-choice",
          ...
          correctAnswer: 2,
          explanation: "'this' refers to the execution context - the object that is executing the current function."
        },
        {
          id: "jfe-4",
          type: "code",
          question: "Add a click event to a button that toggles a class 'active' on itself",
          starterCode: "const btn = document.querySelector('.btn');\n// Write your code here\n",
          correctAnswer: "const btn = document.querySelector('.btn');\nbtn.addEventListener('click', () => {\n  btn.classList.toggle('active');\n});",
          testFunction: (code) => {
            return code.includes("addEventListener") && code.includes("classList.toggle");
          },
          explanation: "Use addEventListener with classList.toggle() to add/remove a class on click."
        },
        {
          id: "jfe-5",
          type: "multiple-choice",
          ...
          correctAnswer: 1,
          explanation: ".filter() returns a new array containing only elements that pass the test function."
        },
        {
          id: "jfe-6",
          type: "code",
          ...
          explanation: "async/await makes promise handling cleaner: async function, await fetch, await .json()."
        },
        {
          id: "jfe-7",
          type: "multiple-choice",
          ...
          correctAnswer: 1,
          explanation: "A callback is a function passed as an argument to be executed later, often for async operations."
        },
        {
          id: "jfe-8",
          type: "code",
          ...
          testFunction: (code) => {
            return code.includes("[") && code.includes("first") && code.includes("second") && code.includes("colors");
          },
          explanation: "Array destructuring uses square brackets: const [first, second] = array;"
        }
      ],
      remedialChallenges: ["js-01", "js-05", "js-10", "js-15", "js-20", "js-25"]
    },
